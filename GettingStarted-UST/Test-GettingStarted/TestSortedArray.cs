...
namespace Test_GettingStarted
{
    ...
    public class TestSortedArray
    {
        ...
        public void NoDuplicatesinArray()
        {
            ...
            SortArrayClass[] myInstances = { new SortArrayClass(0,1), new SortArrayClass(7,1) , new SortArrayClass(5,0) , new SortArrayClass(3,1),
            new SortArrayClass(1,5)};
        ...
        public void FirstelementDuplicatesinArray()
        {
            ...
            //  SimpleClass[] myInstances = { new SimpleClass(8), new SimpleClass(3) , new SimpleClass(19) , new SimpleClass(21),
            //  new SimpleClass(1), new SimpleClass(2) , new SimpleClass(3) , new SimpleClass(4)};
            SortArrayClass[] myInstances = { new SortArrayClass(0,1), new SortArrayClass(5,0) , new SortArrayClass(7,1) , new SortArrayClass(5,5),
            new SortArrayClass(2,3) };
        ...
        public void secondelementDuplicatesinArray()
        {
            ...
            //  SimpleClass[] myInstances = { new SimpleClass(8), new SimpleClass(3) , new SimpleClass(19) , new SimpleClass(21),
            //  new SimpleClass(1), new SimpleClass(2) , new SimpleClass(3) , new SimpleClass(4)};
            SortArrayClass[] myInstances = { new SortArrayClass(0,1), new SortArrayClass(7,1) , new SortArrayClass(5,0) , new SortArrayClass(5,5),
            new SortArrayClass(1,5) , new SortArrayClass(2,4)};
        ...
        public void sortArraywithbothduplicatevalues()
        {
            ...
            //  SimpleClass[] myInstances = { new SimpleClass(8), new SimpleClass(3) , new SimpleClass(19) , new SimpleClass(21),
            //  new SimpleClass(1), new SimpleClass(2) , new SimpleClass(3) , new SimpleClass(4)};
            SortArrayClass[] myInstances = { new SortArrayClass(0,1), new SortArrayClass(4,1) , new SortArrayClass(5,0) , new SortArrayClass(7,1),
            new SortArrayClass(1,5) , new SortArrayClass(5,0)};
