...
namespace Test_GettingStarted
{
    ...
    public class TestSortArray
    {
        ...
        public void NoDuplicatesinArray()
        {
            ...
            SortedArray[] myInstances = { new SortedArray(0,1), new SortedArray(7,1) , new SortedArray(5,0) , new SortedArray(3,1),
            new SortedArray(1,5)};
        ...
        public void FirstelementDuplicatesinArray()
        {
            ...
            //  SimpleClass[] myInstances = { new SimpleClass(8), new SimpleClass(3) , new SimpleClass(19) , new SimpleClass(21),
            //  new SimpleClass(1), new SimpleClass(2) , new SimpleClass(3) , new SimpleClass(4)};
            SortedArray[] myInstances = { new SortedArray(0,1), new SortedArray(5,0) , new SortedArray(7,1) , new SortedArray(5,5),
            new SortedArray(2,3) };
        ...
        public void secondelementDuplicatesinArray()
        {
            ...
            //  SimpleClass[] myInstances = { new SimpleClass(8), new SimpleClass(3) , new SimpleClass(19) , new SimpleClass(21),
            //  new SimpleClass(1), new SimpleClass(2) , new SimpleClass(3) , new SimpleClass(4)};
            SortedArray[] myInstances = { new SortedArray(0,1), new SortedArray(7,1) , new SortedArray(5,0) , new SortedArray(5,5),
            new SortedArray(1,5) , new SortedArray(2,4)};
        ...
        public void sortArraywithbothduplicatevalues()
        {
            ...
            //  SimpleClass[] myInstances = { new SimpleClass(8), new SimpleClass(3) , new SimpleClass(19) , new SimpleClass(21),
            //  new SimpleClass(1), new SimpleClass(2) , new SimpleClass(3) , new SimpleClass(4)};
            SortedArray[] myInstances = { new SortedArray(0,1), new SortedArray(4,1) , new SortedArray(5,0) , new SortedArray(7,1),
            new SortedArray(1,5) , new SortedArray(5,0)};
