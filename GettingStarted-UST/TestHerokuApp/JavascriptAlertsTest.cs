...
namespace TestHerokuApp
{
    ...
    /// </summary>
    [TestFixture]
    internal class JavascriptAlertsTest
    {
        /// <summary>
        /// Test method to execute the title verification of the javascript alert page
        /// </summary>
        [Test]
        public void JavascriptAlertTitleverification() 
        {
        ...
        /// </summary>
        [Test]
        public void verifyJavascriptAlertClickOperation()  
        {
            IHomePage page = new HomePage();
            IJavascriptAlert jsAlert = (JavaScriptAlertPage)page.goToExample("JavaScriptAlert");
        ...
        /// </summary>
        [Test]
        public void verifyJavaScriptConfirmOperation()  
        {
            IHomePage page = new HomePage();
            IJavascriptAlert jsAlert = (JavaScriptAlertPage)page.goToExample("JavaScriptAlert");
        ...
        /// </summary>
        [Test]
        public void verifyJavaScriptPromptOperation()
        {
            IHomePage page = new HomePage();
            IJavascriptAlert jsAlert = (JavaScriptAlertPage)page.goToExample("JavaScriptAlert");
