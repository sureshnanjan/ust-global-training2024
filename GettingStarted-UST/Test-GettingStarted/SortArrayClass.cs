...
{
    internal class SortArrayClass : IComparable<SortArrayClass>
    {
        int value; // simpleClass(1,2)  simpleClass(1,3), simple(0,1), simpl(1,0)
        int value2;
        public SortArrayClass(int val, int val1)
        {
            this.value = val;
            this.value2 = val1;
        ...
        {
            return this.value.Equals(((SortArrayClass)obj).Value);
        }

        public int CompareTo(SortArrayClass? other)
        {
